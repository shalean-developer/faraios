...
export function CompanyCampaignsClient({
  ...
  const statCards = [
    { label: "Total campaigns", value: String(summary.total), hint: "All time" },
    { label: "Drafts", value: String(summary.drafts), hint: "Ready to send" },
    { label: "Emails sent", value: String(summary.totalSent), hint: "Across sent campaigns" },
    {
        ...
        <div className="space-y-6">
          ...
          <section className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div className="border-b border-slate-100 px-5 py-4">
              <h2 className="text-sm font-semibold text-slate-900">Campaign library</h2>
              <p className="mt-1 text-sm text-slate-500">
                  ...
                  {campaigns.length === 0 ? (
                    ...
                    campaigns.map((campaign) => (
                      <tr key={campaign.id}>
                        ...
                        <td className="px-5 py-3 text-right">{campaign.sent_count}</td>
        ...
        <aside className="space-y-6 xl:sticky xl:top-6 xl:self-start">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            ...
            <ul className="mt-3 space-y-1">
              <SidebarLink href={`${base}/customers`} icon={Users} label="Customers" />

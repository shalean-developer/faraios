...
export const metadata = {
  title: "Choose workspace — FaraiOS",
  description: "Select which FaraiOS workspace to open.",
};
  ...
  return (
    <main className="mx-auto min-h-screen max-w-4xl px-4 py-12 sm:px-6">
      <header className="mb-8">
        <p className="text-xs font-semibold uppercase tracking-wider text-violet-600">FaraiOS</p>

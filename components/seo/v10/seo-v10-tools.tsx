  ...
  return (
    <section className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
      <div className="flex flex-col gap-3 border-b border-slate-100 p-4 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-sm font-medium text-slate-700">SEO tools</p>
        <div className="flex flex-wrap gap-2">
          {TABS.map((t) => (
            <button
              ...
              className={
                tab === t.key
                  ? "rounded-md bg-[#5a8dee] px-3 py-1.5 text-xs font-medium text-white"
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="rounded-md bg-[#5a8dee] px-3 py-1.5 text-xs font-medium text-white hover:bg-[#4a7de0] disabled:opacity-50"
          >
            Live crawl
          </button>
        </div>

...
const HOW_IT_WORKS = [
  {
    ...
    desc: "Add your company profile, services, and team in a short onboarding flow.",
    icon: ClipboardList,
  },
  {
    step: "2",
    title: "Run day-to-day ops",
    desc: "Manage bookings, customers, and services from your workspace dashboard.",
    icon: Sparkles,
  },
  {
    step: "3",
    title: "Add a website (optional)",
    desc: "Request a done-for-you build or connect an existing site for bookings sync.",
    icon: BadgeCheck,
  },
  {
    step: "4",
    title: "Grow with support",
    desc: "Hosting, SEO, and ongoing support available as add-ons when you need them.",
    icon: Rocket,
  },
];
        ...
        <div className="mx-auto max-w-6xl">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="mt-2 text-gray-500">
              From workspace setup to optional website launch — you stay in control.
            </motion.p>
          </motion.div>
      ...
      <section className="px-4 pb-8 pt-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          >
            ...
            >
              Ready to run your business on FaraiOS?
            </motion.h2>
            <motion.p variants={fadeUp} className="mb-8 text-lg text-violet-100">
              Set up your workspace in minutes. Add a website build later if you
              want our team to handle it.
            </motion.p>
            <motion.button
              variants={fadeUp}
              type="button"
